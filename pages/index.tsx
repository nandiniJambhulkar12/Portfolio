...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Nandini Jambhulkar',", type: 'array-item' },
    { code: "    role: 'AI/ML & Python Developer',", type: 'array-item' },
    { code: "    bio: 'Passionate about building impactful AI solutions.'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Nandini <span className={styles.accentText}>Jambhulkar</span>
          </h1>

          <div className={styles.developerRole}>AI/ML & Python Developer</div>

          <p className={styles.bio}>
            I&apos;m a CSE student passionate about AI/ML, Data Science, and Web Development.
            I build intelligent and user-centric tools that solve real-world problems.
          </p>
